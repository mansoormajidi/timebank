...
export function TopUpFlow({ onClose, onComplete }: { onClose: () => void; onComplete: (event: ActivityEvent) => void }) {
  ...
  const titles: Record<Step, string> = { amount: 'کوک کردن حساب', gateway: 'پرداخت', processing: 'در حال پرداخت', success: 'رسید کوک حساب' };
