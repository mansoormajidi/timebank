...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'همراه‌بانک | خانه — نسخهٔ روشن', description: 'پروتوتایپ تعاملی Home با خدمات بانکی و اوقاف؛ تمام اطلاعات نمایشی هستند.', locale: 'fa_IR', type: 'website', url: 'https://waqf-bank-home-light-mansvr.mansoormajidi.chatgpt.site', images: [{ url: 'https://waqf-bank-home-light-mansvr.mansoormajidi.chatgpt.site/og.png', width: 1731, height: 909, alt: 'همراه‌بانک، خانه، نسخهٔ روشن' }] },
  twitter: { card: 'summary_large_image', title: 'همراه‌بانک | خانه — نسخهٔ روشن', description: 'پروتوتایپ تعاملی Home با خدمات بانکی و اوقاف؛ تمام اطلاعات نمایشی هستند.', images: ['https://waqf-bank-home-light-mansvr.mansoormajidi.chatgpt.site/og.png'] },
